...
export default async function JoinPage() {
  ...
  return (
    <main className="join-page">
      <div className="apsds-video-bg join-video-bg" aria-hidden>
        <video autoPlay muted loop playsInline preload="auto">
          <source src="/media/Mountainrange_black.mp4" type="video/mp4" />
        </video>
        <div className="join-video-scrim" />
      </div>
      ...
      <div className="join-content">
        ...
        <section className="join-hero min-h-[70vh]">
          <div className="container join-hero-copy grid min-h-[70vh] place-items-center py-20">
            <div className="mx-auto max-w-xl text-center">
              <Reveal>
                <p className="eyebrow eyebrow-center">Join</p>
        ...
        <section id="chapters" className="border-t border-[var(--line)]">
          <div className="container py-20">
              ...
              {openChapters.map((chapter) => (
                <Reveal key={chapter.id}>
                  <Link
                    ...
                    style={{ ["--school-bg" as string]: `url(${chapter.logo})` }}
                  >
            ...
            <Reveal>
              <div className="eyebrow-center mt-16">
            ...
            <div className="mt-6 grid gap-3 lg:grid-cols-3">
              {tracks.map((track, index) => (
                <Reveal key={track.id} delay={(index + 1) as 1 | 2 | 3}>
                  <article className="rounded-[1.35rem] border border-[var(--line)] bg-[rgba(10,10,10,0.35)] p-5 text-center">
